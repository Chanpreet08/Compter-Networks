...
Pkt::Pkt(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->pkt_id = 0;
    this->source = 0;
    this->destination = 0;
...
void Pkt::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->pkt_id);
    doParsimUnpacking(b,this->source);
    doParsimUnpacking(b,this->destination);
    doParsimUnpacking(b,this->type);
}

int Pkt::getPkt_id() const
{
    return this->pkt_id;
}

void Pkt::setPkt_id(int pkt_id)
{
    this->pkt_id = pkt_id;
}
...
int PktDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "pkt_id")==0) return base+0;
...
std::string PktDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Pkt *pp = (Pkt *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getPkt_id());
...
bool PktDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Pkt *pp = (Pkt *)object; (void)pp;
    switch (field) {
        case 0: pp->setPkt_id(string2long(value)); return true;
